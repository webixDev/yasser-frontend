      ...
      <div className="App "> 
        <div className="First-Section PaddingFullApp">
          ...
          <div className="Content">
            <div className="Txt">
              ...
              <p className=' animate__animated animate__bounce'>{t('switchLanguage')}</p>
              <button onClick={()=> {navigate("/AboutMe")}} >{t('تواصل معانا')}</button>
        ...
        <div className="Secound-Section PaddingFullApp  ">
          ...
          <div className="Box-Txt"data-aos="fade-down-right" data-aos-duration="1000">
            ...
            <h4>{t('ماذا عنا')}</h4>
            <h2>{t(`اهلا بكم في مركز `)}<span> {t("خيركم")} </span>{t("لتحفيظ القران الكريم")}</h2>
            <p>{t("نحن نقدم خدمات تحفيظ القران الكريم")}</p>
            <div className="Box">
              <button onClick={()=> {navigate("/Services")}}>{t("اكتشف اكثر")}</button>
              <div className="Txt">
               <a href="
https://wa.me/+201125752800">
          ...
          <div className="Content">
            <div className="Cards">
              <div className="Box-Card-1 ">
                <div className="Card-1" data-aos="flip-left" data-aos-duration="2000"                          >
                  <img src={Ser1} alt="" />
                  <h2>{t("تحفيظ القرآن الكريم")}</h2>
                  <p>{t("نعمل علي تدريب الطلاب على تحفيظ القرآن والمراجعة المنتظمة")}</p>
                </div>
                <div className="Card-2" data-aos="flip-right" data-aos-duration="2000"> 
                  <img src={Ser2} alt="" />
        ...
        <div className="Five-Section PaddingFullApp " >
          <div className="Box-Txt">
            ...
            <p>{t("نعمل من اجل تطوير القيم والأخلاق وتحفيظ القرآن الكريم واحكام التجويد وتعليم نور البيان والقاعدة النورانية")}</p>
            <button onClick={()=> {navigate("/AboutMe")}}>{t("اعرف اكثر")}</button>
          </div>
        </div>
      ...
      <div className="Head-Txt text-center">
        ...
        <div className="Seven-Section PaddingFullApp ">
         ...
         <div className="Box">
          <div className="Txt">
              <h3>{t("حصص")}</h3>
              <p><CountUp start={0} end={1000} duration={30} />+</p>
            </div>
            <div className="Txt">
              <h3>{t("معلم")}</h3>
              <p><CountUp start={0} end={40} duration={50} />+</p>
            </div>
            <div className="Txt">
            <h3>{t("طالب")}</h3>
              <p><CountUp start={0} end={650} duration={40} />+</p>
            </div>
            </div>
            <div className="Box">
            <div className="Txt">
            <h3>{t("منسق")}</h3>
              <p><CountUp start={0} end={25} duration={60} />+</p>
            </div>
            <div className="Txt">
            <h3>{t("اجازات")}</h3>

              <p><CountUp start={0} end={45} duration={30} />+</p>
            </div>
            <div className="Txt">
              <h3>{t("المتفوقين")}</h3>
              <p><CountUp start={0} end={200} duration={50} />+</p>
            </div>
            </div>
